...
namespace RepositoryPattern
{
    ...
    public enum GenreType { Horror = 1, RomCom, SciFi, Documentary, Romance, Drama, Action}
    public class StreamingContent
    {

        //Repo Pattern holds multiples types of classes,, can't be run or tested
        ...
        public bool IsFamilyFriendly
        {
            get
            {
                ...
                //using index of the enum to list it easier. Enums are an int already,
                /*
        ...
        //empty ctor is required and is so people can fill in their own version of property
